...
// To enable changing settings like the tapping term
#define VIAL_QMK_SETTINGS

// markstos: tap toggle feature enabled
...
// markstos: If you press a dual-role key, press another key, and then release the
...
// markstos: When enabled, typing a mod-tap plus second within term will register as the mod-combo
